...
tf.app.flags.DEFINE_float('p_lambda1', 0.0001, """Weight decay regularization parameter. """)
...
tf.app.flags.DEFINE_string('datadir', './Syn_8_8_8_2_10000/syn_biny/', """Data directory. """)
